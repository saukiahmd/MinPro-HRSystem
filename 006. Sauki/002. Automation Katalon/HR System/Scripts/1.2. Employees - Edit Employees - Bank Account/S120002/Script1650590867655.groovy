...
WebUI.setText(findTestObject('Object Repository/1.2. Employees - Edit Employees - Bank Account/input'), 'dimas pratama')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/1.2. Employees - Edit Employees - Bank Account/div_Successfully Added'), 
    0)
