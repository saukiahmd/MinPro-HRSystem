...
WebUI.setText(findTestObject('Object Repository/1.3. Employees - Edit Employees - Social Media/input_Google_google'), '123')

WebUI.setText(findTestObject('Object Repository/1.3. Employees - Edit Employees - Social Media/input_Skype_skype'), '')
