...
WebUI.setText(findTestObject('Object Repository/1.3. Employees - Edit Employees - Social Media/input_Google_google'), 'https://google.com/')
...
WebUI.verifyElementPresent(findTestObject('1.2. Employees - Edit Employees - Bank Account/div_Successfully Added'), 0)
