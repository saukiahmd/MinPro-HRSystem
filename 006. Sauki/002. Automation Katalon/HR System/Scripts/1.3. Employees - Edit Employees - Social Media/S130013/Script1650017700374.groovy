...
WebUI.setText(findTestObject('Object Repository/1.3. Employees - Edit Employees - Social Media/input_Google_google'), '')

WebUI.setText(findTestObject('Object Repository/1.3. Employees - Edit Employees - Social Media/input_Skype_skype'), '123')

WebUI.click(findTestObject('Object Repository/1.3. Employees - Edit Employees - Social Media/i_Save_fa fa-check'))

if (WebUI.verifyElementPresent(findTestObject('1.2. Employees - Edit Employees - Bank Account/div_Successfully Added'), 
    0)) {
    KeywordUtil.markFailed('Berhasil merubah data bank account')
