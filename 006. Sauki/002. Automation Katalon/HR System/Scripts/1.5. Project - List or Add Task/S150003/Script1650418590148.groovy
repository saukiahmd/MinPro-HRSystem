...
WebUI.setText(findTestObject('1.5. Project - List or Add Task/input_Collaborators_select2-search__field'), 'employee empat')
...
WebUI.setText(findTestObject('1.5. Project - List or Add Task/input_Collaborators_select2-search__field'), 'employee lima')
...
WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task Title_tasktitle'), 'Maintenance Software')

WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task Start Date_startdate'), '2022-04-04')

WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task End Date_enddate'), '2022-04-09')

WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/textarea_Details_details'), 'Updating hardware')
