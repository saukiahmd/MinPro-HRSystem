...
WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task Title_tasktitle'), 'Bengkel Komputer4')

WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task Start Date_startdate'), '2022-04-11')

WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task End Date_enddate'), '2022-04-14')
