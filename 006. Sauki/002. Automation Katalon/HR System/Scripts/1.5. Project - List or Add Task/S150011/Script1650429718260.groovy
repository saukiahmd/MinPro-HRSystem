...
WebUI.setText(findTestObject('Object Repository/1.5. Project - List or Add Task/input_Task Title_tasktitle'), 'Update')
...
WebUI.verifyElementPresent(findTestObject('1.5. Project - List or Add Task/label_Please enter at least 8 characters'), 0)
