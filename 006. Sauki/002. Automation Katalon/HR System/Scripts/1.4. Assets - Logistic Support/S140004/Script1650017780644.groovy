...
WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input_Start Date_startdate add'), '2022-04-15')
...
WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input'), 'Employee Dua')
