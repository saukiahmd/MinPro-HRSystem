...
WebUI.click(findTestObject('Object Repository/1.4. Assets - Logistic Support/i_Demo Task Tit_fa fa-pencil-square-o'))
...
WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_End Date_enddate'), '2022-01-10')

WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Refund Date_backdate'), '2022-07-12')

WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Assign Qty_assignqty'), '1')

WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Refund Qty_backqty'), '1')

WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/textarea_Remarks_remarks'), 'employee empat')
