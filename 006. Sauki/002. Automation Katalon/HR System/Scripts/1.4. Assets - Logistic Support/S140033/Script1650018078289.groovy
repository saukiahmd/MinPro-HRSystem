...
WebUI.doubleClick(findTestObject('1.4. Assets - Logistic Support/th_End Date'))

String text1 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_2022-08-10 enddate page 1'))

String text2 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_2022-08-10 enddate page 1'))

while (text1 == text2) {
    WebUI.click(findTestObject('1.4. Assets - Logistic Support/a_Next'))

    text2 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_2022-08-10 enddate page 1'))
}
