...
WebUI.click(findTestObject('1.4. Assets - Logistic Support/a add'))
...
WebUI.verifyElementPresent(findTestObject('1.4. Assets - Logistic Support/label_Please enter a value greater than or equal to 0 assign qty'), 
    0)
