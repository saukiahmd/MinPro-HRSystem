...
WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Assign Qty_assignqty'), '!@#$')
...
WebUI.verifyElementPresent(findTestObject('1.4. Assets - Logistic Support/label_Please enter a value greater than or equal to 0'), 
    0)
