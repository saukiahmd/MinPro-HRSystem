...
WebUI.click(findTestObject('1.5. Project - List or Add Task/laptop 10 add'))
...
WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Start Date_startdate'), '2020-04-30')

WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_End Date_enddate'), '2020-03-01')
...
String text = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/div_Successfully Updated add'))

if (text.toLowerCase().contains('successfully')) {
    KeywordUtil.markFailed('Berhasil menambahkan data logistic support')
}
