...
WebUI.click(findTestObject('Object Repository/1.4. Assets - Logistic Support/li_Employee Empat'))
...
WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input'), 'Employee Empat')

WebUI.verifyTextPresent('Computer a442u', false)
