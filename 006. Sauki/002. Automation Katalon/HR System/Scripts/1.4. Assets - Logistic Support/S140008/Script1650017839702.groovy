...
WebUI.click(findTestObject('1.4. Assets - Logistic Support/li_Laptop T10 fix'))
...
WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input_Start Date_startdate add'), '2020-04-11')

WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input_End Date_enddate add'), '2020-04-12')

WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input_Assign Qty_assignqty add'), '5dan!@#')

WebUI.setText(findTestObject('1.4. Assets - Logistic Support/textarea_Remarks_remarks add'), 'employee dua')

WebUI.click(findTestObject('1.4. Assets - Logistic Support/button_Submit add'))

WebUI.delay(5)

if (WebUI.verifyElementPresent(findTestObject('1.4. Assets - Logistic Support/label_Please enter a value greater than or equal to 0 assign qty'), 
    0)) {
    KeywordUtil.markPassed('Gagal menambahkan data logistic support dan menampilkan teks Please enter a value greater than or equal to 0. dikolom assgin qty')
}
