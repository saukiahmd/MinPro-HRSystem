...
WebUI.click(findTestObject('1.4. Assets - Logistic Support/th_Task Name'))

String text1 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_Demo Task Tit task name page 1'))

WebUI.delay(3)

String text2 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_Demo Task Tit task name page 1'))

while (text1.charAt(0) == text2.charAt(0)) {
    WebUI.click(findTestObject('1.4. Assets - Logistic Support/a_Next'))

    text2 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_Demo Task Tit task name page 1'))
}
