...
String text1 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_1 qty page 1'))

WebUI.delay(3)

String text2 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_1 qty page 1'))

while (text1 == text2) {
	WebUI.click(findTestObject('1.4. Assets - Logistic Support/a_Next'))

	text2 = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/td_1 qty page 1'))
}
