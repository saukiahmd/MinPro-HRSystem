...
WebUI.click(findTestObject('1.4. Assets - Logistic Support/li_Laptop T10 update'))
...
WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input_End Date_enddate add'), '2020-04-13')

WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input_Assign Qty_assignqty add'), '5')

WebUI.setText(findTestObject('1.4. Assets - Logistic Support/textarea_Remarks_remarks add'), 'ludo')
...
WebUI.setText(findTestObject('1.4. Assets - Logistic Support/input'), '2020-04-13')

WebUI.verifyTextPresent('Laptop T10', false)
