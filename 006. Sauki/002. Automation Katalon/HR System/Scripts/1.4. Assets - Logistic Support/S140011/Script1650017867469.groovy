...
WebUI.click(findTestObject('1.4. Assets - Logistic Support/li_Real Estate Site'))

WebUI.click(findTestObject('Object Repository/1.4. Assets - Logistic Support/select_Demo Task Title for TestingIni Task _c857b2'))
...
WebUI.verifyElementPresent(findTestObject('1.4. Assets - Logistic Support/label_This field is required'), 0)
