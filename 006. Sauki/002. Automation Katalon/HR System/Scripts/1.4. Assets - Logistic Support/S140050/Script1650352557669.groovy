...
WebUI.click(findTestObject('Object Repository/1.4. Assets - Logistic Support/a_2'))
...
String text = WebUI.getText(findTestObject('1.4. Assets - Logistic Support/judul update logistik'))

if (text.toLowerCase().contains('update logistice')) {
	...
	WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Start Date_startdate'), '2022-07-12')
	
	WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_End Date_enddate'), '2022-08-10')
	
	WebUI.setText(findTestObject('Object Repository/1.4. Assets - Logistic Support/input_Refund Date_backdate'), '2022-08-12')
	...
	WebUI.click(findTestObject('Object Repository/1.4. Assets - Logistic Support/button_Close'))
	
	WebUI.delay(5)
	
	WebUI.verifyTextPresent('Logistic Support List', false)
} else {
	KeywordUtil.markFailed('Form ubah data tidak muncul')
}
